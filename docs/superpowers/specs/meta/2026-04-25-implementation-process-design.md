...
| 4 | iOS v2 — workouts | ⏳ In progress 2026-04-25 — meta-spec at [`meta/2026-04-25-ios-v2-workouts-design.md`](./2026-04-25-ios-v2-workouts-design.md). 4a (workout data foundation) ✅ code complete: 7-table schema + migration, seeded catalog (21 exercises, 6 routines), pure-function math (rest defaults, volume, PR detection), query modules (routines, prs, sessions with atomic `insertCompletedSession`), seeder wired into app startup, smoke script green. 130 tests passing. 4b–4g pending. |
